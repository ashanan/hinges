...
for x in range(0, cut_columns):
    for y in range(0, cut_rows):
        upperLeftPoint = svgcuts.Point(x * (kerf + cut_distance), y * (cut_length + gap))
        upperRightPoint = svgcuts.Point((x+1)*kerf + x*cut_distance, y * (cut_length + gap))

        lowerLeftPoint = svgcuts.Point(x * (kerf + cut_distance), (y + 1) * cut_length + y * gap)
        lowerRightPoint = svgcuts.Point((x + 1)*kerf + x*cut_distance, (y + 1) * cut_length + y * gap)
